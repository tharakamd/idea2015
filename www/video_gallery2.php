                ...
                <article id="content">
                    <div class="wrapper">
                        <section class="cols">
                            <div class="wrapper pad_bot2">
                                <h3><span class="dropcap">7th</span>Lectuer</h3>
                            ...
                            <div class="wrapper">
                                <h3><span class="dropcap">10</span>Lecture</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                        ...
                        <section class="cols pad_left1">
                            <div class="wrapper pad_bot2">
                                <h3><span class="dropcap">8th</span>Lecture</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                            ...
                            <div class="wrapper">
                                <h3><span class="dropcap">11</span>Lecture</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                    ...
                    <div class="wrapper tabs">
                        ...
                        <ul class="nav">
                            ...
                            <li class="selected"><a id="transition2" href="video_gallery2.php">2</a></li>
                            <li><a id="transition3" href="video_gallery3.php">3</a></li>
                            <li><a id="transition4" href="video_gallery4.php">4</a></li>
                            <li><a id="transition5" href="video_gallery5.php">5</a></li>
