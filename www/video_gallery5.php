...
<html lang="en">
    <head>
        ...
        <title>Idea Challenge | Video Lectures</title>
        <meta charset="utf-8">
        ...
        <script type="text/javascript" src="fancybox/fancy_action.js"></script>
                            ...
                            <div class="wrapper">
                                ...
                                <nav>
                                    <ul id="menu">
                                        ...
                                        <li id="nav3"  class="active" ><a href="video_lectures.php">Video<span>Lectures</span></a></li>
                                        <li id="nav4"><a href="Contacts.php">Contact<span>Us</span></a></li>
                                    </ul>
                                </nav>
                            </div>
                        </header>
            ...
            <div class="main">
                ...
                <article id="content">
                    <div class="wrapper">
                        <section class="cols">
                            <div class="wrapper pad_bot2">
                                <h3><span class="dropcap">25</span>Lectuer</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                                <p class="pad_bot1">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                                <a href="#" class="link1">View Content</a>
                            </div>
                            <div class="wrapper">
                                <h3><span class="dropcap">28</span>Lecture</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                                ...
                                <a href="#" class="link1">View Content</a>images/lec/lec.jpg
                            </div>
                        </section>
                        <section class="cols pad_left1">
                            <div class="wrapper pad_bot2">
                                <h3><span class="dropcap">26</span>Lecture</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                            ...
                            <div class="wrapper">
                                <h3><span class="dropcap">29</span>Lecture</h3>
                                <figure><img src="images/lec/lec.jpg" alt=""></figure>
                    ...
                    <div class="wrapper tabs">
                        ...
                        <ul class="nav">
                            <li><a id="transition" href="video_gallery.php">1</a></li>
                            <li><a id="transition2" href="video_gallery2.php">2</a></li>
                            <li><a id="transition3" href="video_gallery3.php">3</a></li>
                            <li><a id="transition4" href="video_gallery4.php">4</a></li>
                            <li class="selected"><a id="transition5" href="video_gallery5.php">5</a></li>
                            <li><a id="transition6" href="video_gallery6.php">6</a></li>
                        </ul>
                    </div>
